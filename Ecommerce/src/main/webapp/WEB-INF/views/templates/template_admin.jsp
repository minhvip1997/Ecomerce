            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="${pageContext.request.contextPath }/admin-panel/logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="${pageContext.request.contextPath }/admin/category"><i class="fa fa-circle-o"></i>List</a></li>
            <li><a href="${pageContext.request.contextPath }/admin/category/add"><i class="fa fa-circle-o"></i> Add</a></li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="${pageContext.request.contextPath }/admin/product"><i class="fa fa-circle-o"></i>List</a></li>
            <li><a href="${pageContext.request.contextPath }/admin/product/add"><i class="fa fa-circle-o"></i> Add</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="${pageContext.request.contextPath }/admin/customer"><i class="fa fa-circle-o"></i>List</a></li>
          </ul>
        </li>
      <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="${pageContext.request.contextPath }/admin/invoice"><i class="fa fa-circle-o"></i>List</a></li>
          </ul>
        </li>
         <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="${pageContext.request.contextPath }/admin/slide"><i class="fa fa-circle-o"></i>List</a></li>
            <li><a href="${pageContext.request.contextPath }/admin/slide/add"><i class="fa fa-circle-o"></i> Add</a></li>
          </ul>
        </li>
      </ul>
    </section>
